...
OFFICE_CARDS: dict[str, OfficeCard] = {
    "екб": OfficeCard(
        ...
        caption=(
            ...
            "Для наших клиентов доступна бесплатная\n"
            "парковка на 1 час по адресу: <b>ул. Белинского, 86</b>\n"
            "через дорогу от офиса.\n"
            "Въезд на парковку — со стороны перекрёстка\n"
            "<b>ул. Белинского</b> и <b>ул. Тверитина.</b>\n\n"
            "В ближайшее время также будет доступна\n"
            "парковка непосредственно под офисом.\n\n"
