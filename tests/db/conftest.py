...
TRUNCATE
    ...
    best_change_deal_corrections,
    best_change_payments,
    best_change_account_moves,
    best_change_month_closures,
    accounting_import_records,
    accounting_import_runs,
    dashboard_shadow_reports,
    cash_settlements,
